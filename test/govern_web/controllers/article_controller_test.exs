defmodule GovernWeb.ArticleControllerTest do
  use GovernWeb.ConnCase

  import Govern.NewsFixtures

  @create_attrs %{category: "some category", content: "some content", intro: "some intro", name: "some name", photto: "some photto", subname: "some subname"}
